...
#if defined(_MSC_VER)
    #pragma warning(disable : 4711) /* inline selection noise under /Wall */
    #pragma warning(disable : 5045) /* Spectre advisory noise under /Wall */
    #pragma warning(disable : 4018) /* signed/unsigned mismatch in vendored code */
    #pragma warning(disable : 4242) /* narrowing in vendored code */
    #pragma warning(disable : 4244) /* narrowing in vendored code */
    #pragma warning(disable : 4267) /* size_t -> 32-bit in vendored code */
    #pragma warning(disable : 4388) /* signed/unsigned comparisons */
    #pragma warning(disable : 4820) /* struct padding noise under /Wall */
#endif

#include "libsais.h"

#ifndef VERSION
    #define VERSION "1.5.3-7zbz3"
#endif
